...
``flow_view_animate`` renders the same diagram as ``flow_view``, but as an animated GIF that
...
frames = visualtorch.flow.flow_view_animate(model, input_shape, scale_xy=3)
